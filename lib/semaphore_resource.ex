defmodule SemaphoreResource do
  use GenServer
  ...
  defmacro __using__(opts \\ []) do
    ...
    quote do
      def start_link(opts \\ []) do
        ...
        SemaphoreResource.start_link(__MODULE__, unquote(max), opts)
      end
      ...
      """
      @spec acquire() :: :ok
      def acquire(), do: SemaphoreResource.acquire(__MODULE__)
      ...
      def call(func), do: SemaphoreResource.call(__MODULE__, func)

      @doc """
      Releases the underlying semaphore.
      """
      @spec release() :: :ok
      def release(), do: SemaphoreResource.release(__MODULE__)
    end
  end
